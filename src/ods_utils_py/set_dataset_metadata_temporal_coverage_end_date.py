...
def set_dataset_metadata_temporal_coverage_end_date(temporal_coverage_end_date: str | datetime | None, dataset_id: int = None, dataset_uid: str = None, publish: bool = True, should_override_remote_value: bool = True, tzinfo: ZoneInfo =ZoneInfo("Europe/Zurich")) -> None:
    """
